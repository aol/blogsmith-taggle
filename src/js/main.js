...
// Register that the taggle plugin has loaded
window.ampPlugins = $.extend(window.ampPlugins, { 'taggle': { loaded: true } });
	...
	$.widget('aol.easyTags', {
		...
		_create: function () {
			...
			if (this.options.admin) {
				...
				ui.easyTagAdd = $('<img />', {
					'class': 'add',
					src: 'https://s.aolcdn.com/os/blogsmith/plugins/aol-tagger/images/add.png',
					width: '16px',
					height: '16px',
					title: 'Add new tag'
		...
		_addAdminElements: function ($elem) {
			...
			draghandle = $('<img />', {
				'class': 'draghandle',
				src: 'https://s.aolcdn.com/os/blogsmith/plugins/aol-tagger/images/draghandle.png',
				width: '12px',
				height: '12px'
			}).prependTo($elem);
